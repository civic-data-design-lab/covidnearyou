...
To determine the effectiveness of each threshold, we created regressions for the two weeks before and after the starting point day of *X* deaths, based on the linear formula and its exponential transformation, which are described below:
