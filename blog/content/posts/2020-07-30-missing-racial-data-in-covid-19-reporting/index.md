...
(2) For the purposes of this project, we considered the race designation *Other* to be functionally the same asUnknownand therefore we included all cases reported having a race ofOtheras unknown. We carry over this adjustment in all calculations made for unknown visualizations.
