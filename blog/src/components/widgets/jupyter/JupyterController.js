...
import {Input, Dataframe, NotebookStaticOverride, StyleZero, Highlights} from './notebook';
    ...
    return (
      ...
      <Body className={'jupyter'} borderColor={this.state.theme}>
        <Accordion fluid inverted={this.state.colorMode}>
          ...
          <Accordion.Content
            active={this.state.activeIndex === 0}
          ><Test backgroundColor={'hotpink'} color={this.state.theme}
...
const Test = styled.div(
  Dataframe,
  NotebookStaticOverride,Highlights,
 props => Input(props),
  StyleZero
);
